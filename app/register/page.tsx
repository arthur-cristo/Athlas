...
const Register = () => {
    ...
    return (
        ...
        <div className='bg-dark_gray-gradient flex justify-center items-center md:h-screen'>
            <div className='bg-register-gradient flex flex-col justify-center items-center md:h-screen'>
                ...
                <div className='bg-register-card-gradient p-6 md:rounded-md flex flex-col gap-6 md:h-[440px] md:w-[568px] items-center justify-center w-screen'>
                    ...
                    <p className="text-white text-sm text-center">Alredy have an account?&nbsp;
                        <Link href="/login" className="text-green-400 font-bold">Login</Link>
                    </p>
