        ...
        <AlertDialog open={deleteDialog} onOpenChange={setDeleteDialog}>
            <AlertDialogContent className=" border-none rounded-md round w-fit">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        <p className="text-sm text-muted-foreground-400">Are you sure you want to delete this {post ? 'post' : 'comment'}?<br />This action cannot be undone.</p>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className='flex gap-4 mt-4'>
                    <Button
                        onClick={() => setDeleteDialog(false)}
                        className="bg-btn-dark_gray hover:bg-btn-dark_gray round py-6 px-16 "
                        variant={'secondary'}
                    >
                        Cancel
                    </Button>
                    <Button
                        ...
                        className="px-16 w-40 py-6 bg-red-delete round hover:bg-red-delete"
                    >
