...
const DeletePostDialog = ({ post, comment, deleteDialog, setDeleteDialog, setFetch }: DeleteDialogProps) => {
    ...
    return (
        <AlertDialog open={deleteDialog} onOpenChange={setDeleteDialog}>
            <AlertDialogContent className="bg-background border-none rounded-md text-foregroundround w-fit">
                <AlertDialogHeader>
                ...
                <div className='flex gap-4 mt-4'>
                    <Button
                        ...
                        className="bg-btn-dark_gray hover:bg-btn-dark_gray text-foregroundround py-6 px-16 "
                        variant={'secondary'}
                    >
                        Cancel
                    </Button>
                    <Button
                        ...
                        className="px-16 w-40 py-6 bg-red-delete text-foregroundround hover:bg-red-delete"
                    >
